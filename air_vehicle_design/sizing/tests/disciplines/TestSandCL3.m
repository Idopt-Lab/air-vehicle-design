...
%   "never self-referential" rule).
    ...
    methods (Test)
        ...
        % group_weight switch.
            ...
            w = [w3.W_wings, w3.get_weight_HT(w3.W_TO), w3.get_weight_VT(w3.W_TO), ...
                 w3.W_fuselage, w3.get_weight_landing_gear(w3.W_l), ...
                 w3.W_installed_engine, w3.W_subsystems, ...
                 w3.get_weight_strake(w3.W_TO), ...
                 w3.W_payload_fixed + w3.W_payload_expendable, w3.W_energy];
