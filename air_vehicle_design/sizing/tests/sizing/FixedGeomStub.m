...
%   inputs an injected tail-sizing object needs (not part of GeometryBase's
%   abstract contract -- an L2/L3 convention); S_ht/S_vt/S_ail/S_elev/S_rud
%   are plain outputs an injected tail/control-surface-sizing object
%   mutates in place from outside this class, same role as F16GeomL2's own
%   plain properties of the same names.
%
