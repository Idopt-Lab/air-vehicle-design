...
%   running the suite, rather than force-fit or silently loosened away.
    ...
    methods (Test)
        ...
        %
        % FINDING (documented, not silently tightened away -- 2026-07-27):
        % the original step-8 tolerance table expects W_TO in 27,000-37,000 lb
        ...
        % (-42.5% vs. Brandt) -- both below the original step-8 stated bands (the
        ...
        % design_study_03_L3
        %
        % Reuses SizingLoopL2 unmodified [original step-8 plan: "L3
        ...
        % The original step-8 plan gives no separate numeric target band for L3 (only
