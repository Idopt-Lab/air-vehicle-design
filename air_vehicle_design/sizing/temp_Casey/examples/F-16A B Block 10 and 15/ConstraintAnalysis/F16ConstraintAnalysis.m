classdef F16ConstraintAnalysis < ConstraintModel
     ...
     methods
          ...
          function T_Wto = computeWingLoading(constraint_obj, Wto_S, beta, alpha, n, q, V, CD0, K1, Ps)
               T_Wto = ConstraintAnalysisClass.computeWingLoading(Wto_S, beta, alpha, n, q, V, CD0, K1, Ps);
          end

          % Compute takeoff constraint
          function T_Wto = takeoff_constraint(constraint_obj, Wto_S, V_Vstall, beta, alpha, rho, CLmax, distance, CD0, mu)
