...
%   Component order: [1] wing, [2] HT, [3] VT, [4] fuselage, [5] duct
    ...
    methods
        ...
        function v = get.Lambda_m_comp(obj)
            ...
            % shared GeometryBase.convert_sweep identity (fixes the old
            % hardcoded [35 35 42] estimate). Bodies: 0.
            g = obj.geom;
            ...
            vt   = GeometryBase.convert_sweep(g.LE_sweep_vt,   g.AR_vt,   g.lambda_vt,   obj.x_c_max_comp(3));
            v = [wing, ht, vt, 0, 0];
        end
