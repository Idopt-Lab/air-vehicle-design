...
T = [T; arow('e, Brandt Aero!G12 alternate (L2)', 'L2', AeroL2.oswald_eff_brandt(a2.AR_wing, a2.LE_sweep_wing), gt.e0.brandt.value, 'N/A', gt.e0.internet.value, '%.4f', 'Brandt Aero!G12 (e0)', ...
...
T = [T; arow('e, Brandt Aero!G12 alternate (L3)', 'L3', AeroL2.oswald_eff_brandt(a3.AR_wing, a3.LE_sweep_wing), gt.e0.brandt.value, 'N/A', gt.e0.internet.value, '%.4f', 'Brandt Aero!G12 (e0)', ...
