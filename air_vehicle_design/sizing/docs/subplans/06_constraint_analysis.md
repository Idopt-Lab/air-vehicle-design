...
1. Constraint diagram for F-16 with all constraints (8 workbook + stall), design point marked, feasible region shaded (see `examples/F16A/run_F16_constraint_diagram.m`).
