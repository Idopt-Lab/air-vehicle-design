classdef F16ALogicalArchitectureTest < F16ATestCase
    ...
    properties (Constant)
        ...
        % four parameters that belong to a physical candidate.
    ...
    methods (Test)
        ...
        function testKindsCarryNoTradeNumerics(testCase)
            ...
            testCase.verifyFalse(ismember(testCase.RetiredStereotype, declaredStereotypes), ...
                testCase.RetiredStereotype + " is retired from L (D-008): L enumerates " + ...
            ...
            testCase.verifyNoOffenders( ...
                ...
                "cost, TRL or benefit; move the property to the P profile");
            testCase.verifyNoOffenders( ...
                testCase.elementsWithStereotype(testCase.RetiredStereotype), ...
