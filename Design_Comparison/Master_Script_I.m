...
function Master_Script_I(Design, Mission, Requirements, Constraints)



%% ----------------------------------------------------------------------
%% utilities
level = "I"; % Added this to minimize manual changes between fidelity levels
...
[Weight_Results] = weight_est_I(missiondata, Constraints, Designgeo_wings, Designgeo_fuselage, Designgeo_propulsion, min_TW, optimal_WS, DesignTable_weights);
...
% Drag polar I
[DragResults] = Drag_Polar_I(Designgeo_wings, Designgeo_fuselage, Designgeo_propulsion, Weight_Results); % Just call the script
