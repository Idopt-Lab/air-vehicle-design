...
function Master_Script_III(Design, Mission, Requirements, Constraints)



%% ----------------------------------------------------------------------
%% utilities
level = "III"; % Added this to minimize manual changes between fidelity levels
...
[Weight_Results] = weight_est_III(missiondata, Constraints, Designgeo_wings, Designgeo_fuselage, Designgeo_propulsion, min_TW, optimal_WS, DesignTable_weights);
...
[DragResults] = Drag_Polar_III(Designgeo_wings, Designgeo_fuselage, Designgeo_propulsion, Weight_Results); % Just call the script
