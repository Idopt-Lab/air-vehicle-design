...
function [Weight_Results] = weight_est_II(missiondata, Constraints, Designgeo_wings, Designgeo_fuselage, Designgeo_propulsion, min_TW, optimal_WS, DesignTable_weight)
...
% Function: Main Mission Analysis
     function [W_TO, beta, results_table, total_fuel_used, fuel_fraction, empty_weight_fraction, empty_weight, W_Takeoff, W_Climb, W_Cruise, W_Dash, W_Combat, W_Cruise2, W_Loiter, W_Landing, f1, f2, f3, f4, f5, f6, f7, f8, S_ref, S_wet, T0, S_HT, S_VT] = missionAnalysis(mission, min_TW, optimal_WS, Designgeo_wings, Designgeo_fuselage, DesignTable_weight)
          ...
          for iteration = 1:max_iteration
               ...
               [W_Dash, f6]    = segment_dash(W_Cruise, W_S, W_TO, mission.Dash.Dash("q (lbf/ft^2)"), mission.Dash.Dash("CD0"), mission.Dash.Dash("e"), AR, mission.Dash.Dash("TSFC"), mission.Dash.Dash("Range (ft)"), mission.Dash.Dash("Mach number") * mission.Dash.Dash("a (ft/s)"));
               [W_Combat, f7]  = segment_combat(W_Dash, mission.Combat.Combat("Time (min)"), mission.Combat.Combat("TSFC"), mission.Combat.Combat("Payload, drop (lbf)"), mission.Combat.Combat("CD0"), mission.Combat.Combat("e"), AR, W_TO, W_S, mission.Combat.Combat("q (lbf/ft^2)"));
               ...
               [empty_weight] = Compute_OEW_II(W_TO, S_ref, T0, AR);
