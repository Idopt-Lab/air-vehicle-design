...
- Keep TSFC units consistent and documented. The code keeps TSFC in **1/hr** throughout (there is no `/3600 → 1/s` conversion) — don't introduce a silent unit change; if you change units, change the docstring and every caller.
