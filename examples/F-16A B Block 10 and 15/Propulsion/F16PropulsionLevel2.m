classdef F16PropulsionLevel2 < PropulsionModelLevel2
     ...
     methods
          ...
          function obj = F16PropulsionLevel2()
               ...
               obj.TSFC.wet_sl = PropulsionLevel2.get_TSFC_installed("low bypass mixed turbofan", [0, 0], "max");
               obj.TSFC.dry_sl = PropulsionLevel2.get_TSFC_installed("low bypass mixed turbofan", [0, 0], "max");
          end
