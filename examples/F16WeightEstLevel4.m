classdef F16WeightEstLevel4 < WeightEstModel
     ...
     methods
          ...
          function output = get_subsystem_weight(weight_obj, mission_obj, design)
               % Need W_TO
               design.WeightResults.subsystem = subsystem_weight_IV(design.weights, W_TO, T0, W_engine_installed);
          end
